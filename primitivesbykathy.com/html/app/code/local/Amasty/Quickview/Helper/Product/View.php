...
class Amasty_Quickview_Helper_Product_View extends Mage_Catalog_Helper_Product_View
{
    public function initProductLayout($product, $controller)
    {
        ...
        /**
         * This is the only modification to this file. IF using amquickview, using this handle found in catalog.xml
         */
        if (Mage::app()->getRequest()->getModuleName() === 'amquickview') {
            $update->addHandle('PRODUCT_QUICKVIEW');
        }
